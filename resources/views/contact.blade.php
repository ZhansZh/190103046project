 ...
 <main class="py-4">
	...
	<div id="Contact">
					<div class="container mt-5">
						<span class="bg-dark text-white">{{__('Contact me')}}</span> <hr class="bg-dark">
						<div class="row">
							<div class="col">
								<div class="card bg-white">
									<div class="card-header">
										<h4 class="my-4">{{__('Contact me')}}</h4>
									<form action="/question" method="POST" enctype="multipart/form-data">
										...
										<div class = "form-group">
											<label for="Profile Photo">File</label>
										...
										<div class="form-group ">
											<button type = "submit" id = "question" onclick="" class="btn btn-success text-white">{{__('Submit')}}</button>	
										</div>
